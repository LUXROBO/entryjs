...
Entry.BlockToLuxJsParser = class {
    constructor() {
        this._type = 'BlockToLuxJsParser';
        ...
        _blockTokens.forEach((token) => {
            ...
            if (syntaxObj) {
                switch (syntaxObj.key) {
                    ...
                    case 'HW_MOTOR_A_ANGLE_CHANGE': {
                        resultTextCode = Entry.TextCodingUtil.assembleMotorAAgngleChangeBlock(
                            block,
                            resultTextCode
                        );
                    ...
                    case 'HW_MOTOR_B_ANGLE_CHANGE': {
                        resultTextCode = Entry.TextCodingUtil.assembleMotorBAgngleChangeBlock(
                            block,
                            resultTextCode
                        );
    ...
    searchSyntax(datum) {
        ...
        if (schema && schema.syntax) {
            const syntaxes = schema.syntax.js.concat();
